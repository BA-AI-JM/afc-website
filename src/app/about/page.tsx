        ...
        <div className="section-padding">
          <div className="max-w-3xl">
            ...
            <div className="space-y-6 text-afc-text text-lg leading-relaxed">
              ...
              <p>
                Ten years and 42+ events later, AFC has grown into one of the UK&apos;s largest regional MMA promotions. Cards regularly feature up to 30 fights per event, mixing professional and amateur bouts across every weight class. Nearly 1,000 fighters have stepped into the AFC cage.
              </p>
              <p>
